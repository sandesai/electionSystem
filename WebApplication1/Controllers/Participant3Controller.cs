...
{
    public class Participant3Controller : ApiController
    {
        ...
        public Participant3 Get(int ElecNo, string algo, int NoOfParty=0)
        {
            ...
            //add new entry
            string sql = "UPDATE electTable set electionNo =" + ElecNo + ",vote =" + vote + " WHERE participant=3";
